...
namespace origami {
    namespace oint {
        ...
        void Runtime :: make_function(std::string name, std::vector<std::string> (*function)(const std::vector <std::string>& args, origami::oint::Runtime* runtime)){
